...
- 若 `custom/index.md`、`custom/manual.md` 或 `lessons/CustomTools.ggb` 已提供可重用工具（例如 `MidpointOnSphere`、`ArcOnSphere`、`NextGen`、`NestedSpiral`），應優先複用或移植該工具，而不是重新手寫冗長的 `Sequence`、`Flatten`、`Join` 展開式。
